...
export function RgForm({ catalogYears, initial, onSubmit, submitLabel }: Props) {
  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-lg space-y-5">
      ...
      <div>
        <label className="block text-sm font-medium text-gray-700 mb-1.5">Catalog Year</label>
        <select
          required
          value={catalogYearId}
      ...
      <div className="grid grid-cols-2 gap-4">
        <div>
          <label className="block text-sm font-medium text-gray-700 mb-1.5">Min Credits</label>
          <input
            type="number"
            min="0"
            step="0.5"
