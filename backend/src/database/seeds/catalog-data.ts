...
export interface PrerequisiteSeed {
  ...
  /**
   * Rows sharing a group for the same course are alternatives — "CS250 or
   * CS360" — and any one of them satisfies it. Omitted means the prerequisite
   * stands alone and is required outright.
   */
...
export const PREREQUISITES: PrerequisiteSeed[] = [
  ...
  // Alternatives the catalog states as "A or B". Grouped, so satisfying either
  // one satisfies the requirement — recording them ungrouped would demand both,
  // and omitting them (which is what happened until now) made these five courses
  // look as though they had no prerequisite at all.
  { courseCode: 'CS480', prerequisiteCode: 'CS250', alternativeGroup: 1 },
  { courseCode: 'CS480', prerequisiteCode: 'CS360', alternativeGroup: 1 },
  { courseCode: 'CS480L', prerequisiteCode: 'CS250L', alternativeGroup: 1 },
  { courseCode: 'CS480L', prerequisiteCode: 'CS360L', alternativeGroup: 1 },
  { courseCode: 'CS556', prerequisiteCode: 'CS360', alternativeGroup: 1 },
  { courseCode: 'CS556', prerequisiteCode: 'CS500', alternativeGroup: 1 },
  { courseCode: 'DS520', prerequisiteCode: 'CS500', alternativeGroup: 1 },
  { courseCode: 'DS520', prerequisiteCode: 'DS501', alternativeGroup: 1 },
  { courseCode: 'DS565', prerequisiteCode: 'CS500', alternativeGroup: 1 },
  { courseCode: 'DS565', prerequisiteCode: 'DS501', alternativeGroup: 1 },
];
